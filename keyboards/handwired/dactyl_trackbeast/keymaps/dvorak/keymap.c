...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LAYER0] = LAYOUT(
    ...
    TT(1), KC_SCLN, KC_Q, KC_J, KC_K, KC_X,                                 KC_B, KC_M, KC_W, KC_V, KC_Z, KC_BSLS,
            KC_BTN1, KC_BTN3 , KC_LCPO, LALT_T(KC_LCBR),                RCTL_T(KC_RPRN), RALT_T(KC_RCBR),
                    LCTL(KC_S),  KC_LGUI ,                                   KC_SFTENT ,  KC_SPC,
                    KC_BSPC  , KC_DEL  ,                                     TT(2), KC_BSPC
    ),
[_LAYER1] = LAYOUT(
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,                       KC_RBRC, KC_7, KC_8, KC_9,KC_RSFT , KC_PLUS,
    KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,                    KC_MINS, KC_4, KC_5, KC_6, KC_MINS, KC_PIPE,
    TT(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,KC_BTN8,               KC_EQL, KC_1, KC_2, KC_3, KC_EQL, KC_UNDS,
            KC_TRNS, KC_TRNS, LCTL(KC_D), KC_PSCR,                                KC_0, KC_TRNS,
                            KC_UP, KC_PGUP,                     LCTL(KC_X),LCTL(KC_C) ,
                            KC_DOWN, KC_PGDN,          TT(0), LCTL(KC_V)
    ),
[_LAYER2] = LAYOUT(
    ...
    TO(0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD,
           KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,                   KC_EQL, KC_MUTE,
                           KC_MS_WH_UP , KC_BTN6,                     KC_TRNS, KC_TRNS,
                           KC_MS_WH_DOWN , KC_BTN7,           TO(0), KC_TRNS
    )
};
